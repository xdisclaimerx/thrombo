 ...
 */
function t360weekend_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 't360weekend_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.t360weekend-front-page) .entry-title,
...
.colors-custom .t360weekend-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.t360weekend-front-page .panel-content .recent-posts article,
...
.colors-custom.t360weekend-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 't360weekend_custom_colors_css', $css, $hue, $saturation );
}
